...
author:
  ...
  - name: Francesco Aletta
    ...
    affiliations:
        - ref: ucl-iede
abstract: |
  In depth description for the procedure developed for the paper: "Soundscape descriptors in eighteen languages: translation and validation through listening experiments". The R and Python code for the various tables, figures, and analyses presented in this document can be found in *Supplementary Material (B) - Code for Steps 1 & 2, Browne's Circular Stochastic Process Model* and *Supplementary Material (C) - Code for Steps 2 through 4: Compiling Step 2 results and running Steps 3 and 4*.
